                ...
                <div className="contact-box">
                    <motion.div className="left-box" initial={{opacity: 0, y: '-50px'}} whileInView={verticalLeft}>
                        ...
                        <div className="contact-hello">
                            <p>Say Hello</p>
                            <Link className='hello-links' to="//wa.me/+919381752077" target='_blank'>Contact Me on WhatsApp</Link>
                            <a className='hello-links' href="mailto:228R5A0407@gmail.com" target='_blank' rel="noreferrer">228r5a0407@gmail.com</a>
                        </div>
                    </motion.div>
                    <motion.div className="right-box" initial={{opacity: 0, y: '50px'}} whileInView={verticalLeft}>
                        ...
                        >
                            ...
                            <div className="message">
                                ...
                                name="message"
                                id="message"
                                placeholder="Hi, please drop your message here."
                                required
                                ></textarea>
                            </div>
                            </div>
